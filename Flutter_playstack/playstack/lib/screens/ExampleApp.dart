...
//const kUrl1 = 'http://playstack.azurewebsites.net/media/audio/Audio5.mp3';
          ...
          Column(children: [
            ...
            Row(children: [
              _Btn(
                  txt: 'Audio 1',
                  onPressed: () async {
                    String _tempUrl = await _getSongUrl();
                    if (_tempUrl != null) {
                      print("URL seteada : " + _tempUrl);
                      widget.advancedPlayer.setUrl(_tempUrl);
                    }
